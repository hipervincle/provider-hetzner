...
type ServerInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/miaits/provider-hetzner/apis/cluster/server/v1alpha1.PlacementGroup
	...
	// +crossplane:generate:reference:type=github.com/miaits/provider-hetzner/apis/cluster/server/v1alpha1.SSHKey
