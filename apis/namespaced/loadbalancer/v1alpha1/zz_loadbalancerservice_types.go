...
type LoadBalancerServiceHTTPInitParameters struct {

	// List of IDs from certificates which the Load Balancer has.
	// +crossplane:generate:reference:type=github.com/miaits/provider-hetzner/apis/namespaced/network/v1alpha1.ManagedCertificate
	// +listType=set
	Certificates []*float64 `json:"certificates,omitempty" tf:"certificates,omitempty"`

	// References to ManagedCertificate in network to populate certificates.
	// +kubebuilder:validation:Optional
	CertificatesRefs []v1.NamespacedReference `json:"certificatesRefs,omitempty" tf:"-"`

	// Selector for a list of ManagedCertificate in network to populate certificates.
	// +kubebuilder:validation:Optional
...
type LoadBalancerServiceHTTPObservation struct {
...
type LoadBalancerServiceHTTPParameters struct {
...
type LoadBalancerServiceInitParameters struct {
	...
	// HTTP configuration when protocol is http or https.
	HTTP []LoadBalancerServiceHTTPInitParameters `json:"http,omitempty" tf:"http,omitempty"`
...
type LoadBalancerServiceObservation struct {

	// Port the service connects to the targets on, required if protocol is tcp. Can be everything between 1 and 65535.
	DestinationPort *float64 `json:"destinationPort,omitempty" tf:"destination_port,omitempty"`

	// HTTP configuration when protocol is http or https.
	HTTP []LoadBalancerServiceHTTPObservation `json:"http,omitempty" tf:"http,omitempty"`
...
type LoadBalancerServiceParameters struct {
	...
	// HTTP configuration when protocol is http or https.
	// +kubebuilder:validation:Optional
	HTTP []LoadBalancerServiceHTTPParameters `json:"http,omitempty" tf:"http,omitempty"`
...
// LoadBalancerServiceSpec defines the desired state of LoadBalancerService
type LoadBalancerServiceSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            LoadBalancerServiceParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider LoadBalancerServiceInitParameters `json:"initProvider,omitempty"`
}

// LoadBalancerServiceStatus defines the observed state of LoadBalancerService.
type LoadBalancerServiceStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        LoadBalancerServiceObservation `json:"atProvider,omitempty"`
}
...
// LoadBalancerService is the Schema for the LoadBalancerServices API. Define services for Hetzner Cloud Load Balancers.
...
type LoadBalancerService struct {
	...
	Spec   LoadBalancerServiceSpec   `json:"spec"`
	Status LoadBalancerServiceStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// LoadBalancerServiceList contains a list of LoadBalancerServices
type LoadBalancerServiceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []LoadBalancerService `json:"items"`
}

// Repository type metadata.
var (
	LoadBalancerService_Kind             = "LoadBalancerService"
	LoadBalancerService_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: LoadBalancerService_Kind}.String()
	LoadBalancerService_KindAPIVersion   = LoadBalancerService_Kind + "." + CRDGroupVersion.String()
	LoadBalancerService_GroupVersionKind = CRDGroupVersion.WithKind(LoadBalancerService_Kind)
)

func init() {
	SchemeBuilder.Register(&LoadBalancerService{}, &LoadBalancerServiceList{})
}
